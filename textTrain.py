...
from generator import SynthText_DataGenerator_Centerline_Localheight
...
image_root_path = 'E:/Spatial Computing & Informatics Laboratory/CutTextArea/dataset/SynthText/SynthText/'
prefix = 'text_w100e50_'
...
ckpt_filepath = '../t_weights/'+ prefix + 'finetune_map_model_bsize8_w1_spe'+str(steps_per_epoch)+'_ep{epoch:02d}.hdf5'
model_ckpt = keras.callbacks.ModelCheckpoint(ckpt_filepath,period = 10)
myvalidation_steps = 5


train_datagen = SynthText_DataGenerator_Centerline_Localheight(image_root_path = image_root_path, batch_size= 8,  seed = 3333, mode = 'training')
...
model.save('../t_weights/finetune_map_model_' + ith + '.hdf5')

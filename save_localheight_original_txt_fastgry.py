...
map_images = glob.glob('E:/Spatial Computing & Informatics Laboratory/CutTextArea/dataset/original_size_OS_USGS_jpg/*.jpg')

output_path = '../mapLevel_results_fast_test/'
saved_weights = '../weights/finetune_map_model_map_modelv2_w1e50_e0_bsize8_spe200_ep50.hdf5'
...
choose_list=['101201496.jpg','102903919.jpg','103199059.jpg','USGS-15-CA-brawley-e1957-s1957-p1961.jpg','USGS-15-CA-capesanmartin-e1921-s1917.jpg','USGS-15-CA-sanfrancisco-e1899-s1892-rp1911.jpg']
...
for map_path in map_images:
    ...
    if base_name not in choose_list:
        continue

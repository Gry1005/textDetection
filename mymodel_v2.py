...
def model_U_VGG_Centerline_Localheight():
    ...
    #deconv
    h2_r= layers.Conv2DTranspose(64, (3, 3), strides=(2, 2), padding='same',
    ...
    #deconv
    h3_r = layers.Conv2DTranspose(32, (3, 3), strides=(2, 2), padding='same',
                                  activation='relu', name='resize_h3')(h3)

    h4_take = Concatenate()([x0, h3_r])
    ...
    #deconv
    h4_r = layers.Conv2DTranspose(32, (3, 3), strides=(2, 2), padding='same',
    ...
    #deconv
    h41_r = layers.Conv2DTranspose(32, (3, 3), strides=(2, 2), padding='same',

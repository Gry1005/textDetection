...
image_root_path = 'E:/Spatial Computing & Informatics Laboratory/CutTextArea/dataset/concat_out_text_space/'
prefix = 'mapTrain4_w100e50_'
...
weights1 = np.array([1., 1., weight_ratio]) # probability map for text region, border and background
weights2 = np.array([weight_ratio, 1.]) # probability map for background and centerline
...
train_datagen = SynthMap_DataGenerator_Centerline_Localheight(image_root_path = image_root_path, batch_size= 8,  seed = 3333, mode = 'training')

...
from generator_manySets import SynthMap_DataGenerator_Centerline_Localheight
...
image_root_path = 'E:/Spatial Computing & Informatics Laboratory/CutTextArea/dataset/synthMap_curved_os_z14/'
prefix = 'curved_od_z14_'

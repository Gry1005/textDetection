    ...
    def __getitem__(self, batch_idx):
        ...
        for map_path, label_path in zip(subset_X, subset_Y):
            ...
            for line in data:
                ...
                cv2.line(centerline_img, left_pt, right_pt, (0, 1, 0), thickness)

                #create localheight image
                cv2.line(localheight_img, left_pt, right_pt, (lh, 0, 0), thickness)
    ...
    def __getitem__(self, batch_idx):
        ...
        for map_path, bboxes in zip(subset_X, subset_Y):
            ...
            for x_c, y_c, theta, wh, lr_pt in zip(x_c_array, y_c_array, thetas, whs, lr_pts):
                ...
                #create localheight image
                cv2.line(localheight_img, left_pt, right_pt, (int(lh), 0, 0), thickness)

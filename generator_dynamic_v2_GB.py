...
class SynthMap_DataGenerator_Centerline_Localheight_Dynamic(object):
    ...
    def __init__(self, image_root_path,fonts_path, GB_path, batch_size=128, seed=1234, mode='training', border_percent=0.15,overlap=True,fontSizeRange=[10,80],grey=[0,128],showPicDir='No'):

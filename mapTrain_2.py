...
import glob
import math
from loss import weighted_categorical_crossentropy, mean_squared_error_mask, mean_squared_error_localheight
...
from generator import SynthMap_DataGenerator_Centerline
...
train_datagen = SynthMap_DataGenerator_Centerline(image_root_path = image_root_path, batch_size= 8,  seed = 3333, mode = 'training')
